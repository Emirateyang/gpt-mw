...
class AlreadySetupError(BaseHTTPException):
    ...
    description = "AI has been successfully installed. Please refresh the page or return to the dashboard homepage."
    code = 403


class NotSetupError(BaseHTTPException):
    error_code = 'not_setup'
    description = "AI has not been initialized and installed yet. " \
